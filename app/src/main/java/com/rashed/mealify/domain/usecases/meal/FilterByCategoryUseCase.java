...
public class FilterByCategoryUseCase {
    ...
    public FilterByCategoryUseCase(MealRepository repository) {
        this.repository = repository;
    }

    public Result<List<Meal>> execute(String categoryName) {
        Result<MealsResponse> result = repository.filterByCategory(categoryName);
